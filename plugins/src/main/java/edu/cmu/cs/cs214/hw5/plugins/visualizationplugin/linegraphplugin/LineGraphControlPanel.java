...
/**
 * The {@code LineGraphControlPanel} class represents the
 * control panel of {@code LineGraphPlugin}.
 *
 * @author Team6
 */
public class LineGraphControlPanel extends ControlPanel {
    private static final int STRUT = 10;

    LineGraphControlPanel(String controlPanelName, Plugin plugin) {
